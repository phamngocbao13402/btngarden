<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Thống kê bình luận</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Thống kê bình luận</h1>
			</div>
		</div><!--/.row-->
					...
					<form action="index.php" method="post">
                        <table 
                            ...
                            <tr><th style="text-align: center">STT</th>
                                ...
                                <th style="text-align: center">BÌNH LUẬN MỚI NHẤT</th>
                                <th style="text-align: center">BÌNH LUẬN CŨ NHẤT</th>
