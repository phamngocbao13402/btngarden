                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required name="ma_hh" class="form-control" readonly value="Auto number">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input required name="giam_gia"  min="0" class="form-control">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required name="ngay_nhap" class="form-control datepicker" type="date" >

                                </div>

                                <div class="form-group">
                                        <label>Mô tả sản phẩm</label>
                                        <textarea name="mo_ta" required class="form-control" rows="3"></textarea>
                                </div>

                                <div class="form-group">
                                        <label>Số lượt xem</label>
                                        <input readonly name="so_luot_xem"  class="form-control" value="0"></input>
                                </div>
                                ...
                                <button type="submit" class="btn btn-success"><a href="index.php?btn_list" style="text-decoration: none; color: white;">Danh sách</a></button>
                            </div>
                            <div class="col-md-6">
