<?php 
    ...
    // Show tất cả các bình luận thuộc về hàng hóa nào đó
    function binh_luan_select_by_hang_hoa($ma_hh) {
        $sql = "SELECT k.*,b.*, h.ten_hh FROM binh_luan b JOIN khach_hang k ON k.ma_kh = b.ma_kh JOIN hang_hoa h ON h.ma_hh=b.ma_hh WHERE b.ma_hh=? ORDER BY ngay_bl DESC";
